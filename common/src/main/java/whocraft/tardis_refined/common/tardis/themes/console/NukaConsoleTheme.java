...
public class NukaConsoleTheme extends ConsoleThemeDetails {
    ...
    public ControlSpecification[] getControlSpecification() {
        return new ControlSpecification[] {
                ...
                new ControlSpecification(ConsoleControl.SPEED_MODIFIER, new Vector3f(0.8250000029802322F, 0.6000000238418579F, -0.37499999068677425F),  EntityDimensions.scalable(0.2F, 0.15F)),
        };
    }
}
